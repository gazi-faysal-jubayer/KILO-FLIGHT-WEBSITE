...
export const metadata = {
  title: 'Sub-Teams & Workflows | Team KILOFLIGHT KUET Formula Student',
  description: '6 engineering and business sub-teams with their step-by-step development workflows for KILOFLIGHT PHOENIX.',
};
