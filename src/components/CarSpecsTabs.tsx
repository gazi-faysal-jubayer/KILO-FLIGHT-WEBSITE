    ...
    <div className="row g-4 align-items-center">
      ...
      <div className="col-lg-6">
        <div className="glass-panel p-4 position-relative overflow-hidden">
          <div className="position-relative w-100 rounded mb-4 overflow-hidden" style={{ height: '260px', border: '1px solid var(--card-border)' }}>
            <Image
          ...
          <div className="row g-3 text-center">
            <div className="col-6 col-md-3">
              <div className="p-2 rounded" style={{ background: 'rgba(255,255,255,0.03)' }}>
                <div className="fs-5 fw-bold text-white font-orbitron">85 HP</div>
                <div className="small text-muted">PEAK POWER</div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="p-2 rounded" style={{ background: 'rgba(255,255,255,0.03)' }}>
                <div className="fs-5 fw-bold text-white font-orbitron">12.5k</div>
                <div className="small text-muted">MAX RPM</div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="p-2 rounded" style={{ background: 'rgba(255,255,255,0.03)' }}>
                <div className="fs-5 fw-bold text-white font-orbitron">85 KG</div>
                <div className="small text-muted">AERO DOWNFORCE</div>
              </div>
            </div>
            <div className="col-6 col-md-3">
              <div className="p-2 rounded" style={{ background: 'rgba(255,255,255,0.03)' }}>
                <div className="fs-5 fw-bold text-white font-orbitron">50+</div>
                <div className="small text-muted">CAN SENSORS</div>
              </div>
            </div>
          </div>
        </div>
          ...
          {activeTab === 'aero' && (
            <div>
              ...
              <div className="mb-3">
                ...
                <div style={{ height: '6px', background: 'rgba(255,255,255,0.1)', borderRadius: '3px', marginTop: '6px', overflow: 'hidden' }}>
